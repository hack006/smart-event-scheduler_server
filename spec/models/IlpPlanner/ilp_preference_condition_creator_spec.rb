...
module IlpPlanner
  RSpec.describe PreferenceConditionCreator, type: :model do
    ...
    it 'Should correctly build AND conditions' do
      ...
      condition_creator = PreferenceConditionCreator.new(slot)

      test_setups = [
          {participant_count: 2, row_coefficients: [1, 1, 0, 0]},
          {participant_count: 3, row_coefficients: [1, 1, 1, 0]}
      ]
      ...
      test_setups.each do |setup|
        ...
        expect(condition.row_coefficients).to eq setup[:row_coefficients]
    ...
    it 'Should correctly build OR conditions' do
      ...
      test_setups = [
          {participant_count: 2, row_coefficients: [1, 1, 0, 0], right_side: 1},
          {participant_count: 3, row_coefficients: [1, 1, 1, 0], right_side: 1}
      ]
    ...
    it 'Should correctly build (..||..) => conditions' do
      ...
      test_data = [
          {participant_count: 2, row_coefficients: [1, -1, 0, 0]},
          {participant_count: 3, row_coefficients: [1, 1, -2, 0]},
          {participant_count: 4, row_coefficients: [1, 1, 1, -3]}
      ...
      test_data.each do |data|
        ...
        expect(condition.row_coefficients).to eq data[:row_coefficients]
    ...
    it 'Should correctly build (..&&..) => conditions' do
      ...
      test_data = [
          {participant_count: 3, row_coefficients: [1, 1, -1, 0], right_side: 1},
          {participant_count: 4, row_coefficients: [1, 1, 1, -1], right_side: 2}
    ...
    it 'Should correctly build (!..&&..!) => conditions' do
      ...
      test_data = [
          {participant_count: 2, row_coefficients: [1, 1, 0, 0]},
          {participant_count: 3, row_coefficients: [1, 1, 1, 0]},
          {participant_count: 4, row_coefficients: [1, 1, 1, 1]}
      ...
      test_data.each do |data|
        ...
        expect(condition.right_side_value).to eq 1
      end
